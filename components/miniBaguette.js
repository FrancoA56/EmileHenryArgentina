...
export default function MiniBaguette() {
  ...
  return (
    <>
      <section className={styles.main} id="miniBaguette">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Molde Mini Baguette:</div>
        ...
        <div className={styles.lightbox} onClick={closeLightbox}>
          ...
          >
            <Image
              ...
              alt={`Mini Baguette ${selectedImageIndex + 1}`}
              fill
