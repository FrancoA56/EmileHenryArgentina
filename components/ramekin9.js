...
export default function Ramekin9() {
  ...
  return (
    <>
      <section className={styles.main} id="ramekin9">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Ramekin N°9:</div>
        ...
        <div className={styles.especifics}>
          <div className={styles.main_block}>
            ...
            <div className={styles.main_sub_text}>
              El Ramekin N°9 es perfecto para porciones individuales pequeñas
