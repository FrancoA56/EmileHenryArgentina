...
export default function Cobertor() {
  ...
  return (
    <>
      <section className={styles.main} id="cobertor">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Cobertor Charlotte:</div>
        ...
        <div className={styles.lightbox} onClick={closeLightbox}>
          ...
          >
            <Image
              ...
              alt={`Cobertor  ${selectedImageIndex + 1}`}
              fill
