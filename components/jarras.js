...
export default function Jarra() {
  ...
  return (
    <>
      <section className={styles.main} id="jarra">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Jarra:</div>
        ...
        <div className={styles.especifics}>
          <div className={styles.main_block}>
            ...
            <div className={styles.main_sub_text}>
              ...
              un estante del refrigerador. <br />
              Cuando hace calor, la cerámica tiene la ventaja de mantener el
              contenido fresco incluso después de sacarla de la heladera.
        ...
        <div className={styles.lightbox} onClick={closeLightbox}>
          ...
          >
            <Image
              ...
              alt={`Jarra ${selectedImageIndex + 1}`}
              fill
