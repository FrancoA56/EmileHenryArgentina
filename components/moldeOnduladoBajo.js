...
const imagenesFuentes = [
  "/img/onduladoBajo/1.webp",
  "/img/onduladoBajo/2.webp",
  "/img/onduladoBajo/3.webp",
  "/img/onduladoBajo/4.webp",
...
export default function OnduladoBajo() {
  ...
  return (
    <>
      <section className={styles.main} id="moldeOnduladoBajo">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Molde Ondulado Bajo:</div>
