...
export default function Salero() {
  ...
  return (
    <>
      <section className={styles.main} id="salero">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Salero:</div>
        ...
        <div className={styles.especifics}>
          ...
          <div className={styles.main_block}>
            ...
            <div className={styles.variaciones_color}>
              ...
              <div className={styles.azulOscuro} title="Blue Flame"></div>
        ...
        <div className={styles.lightbox} onClick={closeLightbox}>
          ...
          >
            <Image
              ...
              alt={`Salero ${selectedImageIndex + 1}`}
              fill
