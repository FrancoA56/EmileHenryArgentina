...
export default function Hogaza() {
  ...
  return (
    <>
      <section className={styles.main} id="hogaza">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Molde Hogaza:</div>
        ...
        <div className={styles.especifics}>
          <div className={styles.main_block}>
            ...
            <div className={styles.main_sub_text}>
              El Molde Pan Hogaza de Emile Henry está diseñado para recrear en
        ...
        <div className={styles.lightbox} onClick={closeLightbox}>
          ...
          >
            <Image
              ...
              alt={`Hogaza ${selectedImageIndex + 1}`}
              fill
