        ...
        <div className={styles.especifics}>
          <div className={styles.main_block}>
            ...
            <div className={styles.main_sub_text}>
              ...
              frutas y verduras con todo su sabor y frescura. Base de cerámica
              esmaltada: Fácil limpieza y protección contra manchas Tapa de
              corcho natural: Absorbe humedad y evita la proliferación de
              bacterias Ventilación controlada: 3 orificios estratégicos para
              flujo de aire óptimo Doble función: Almacena verduras en la base +
              frutas en la tapa cóncava Materiales seguros: 100% libres de
              tóxicos y metales pesados Fácil mantenimiento: Base apta para
              lavavajillas, tapa limpiable con paño Garantía: 10 años de
              respaldo Emile Henry Capacidad: 4.7 litros. Fabricado en Francia,
              este innovador bowl es la solución perfecta para quienes buscan
              practicidad y diseño en su cocina. Un accesorio que combina
              tecnología de conservación con la elegancia característica de
              Emile Henry.
            </div>
          </div>
          <div className={styles.main_block}>
