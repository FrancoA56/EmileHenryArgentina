...
const imagenesFuentes = [
  "/img/ramekin10/1.webp",
  "/img/ramekin10/2.webp",
  "/img/ramekin10/3.webp",
  "/img/ramekin10/4.webp",
  "/img/ramekin10/5.webp",
  "/img/ramekin10/6.webp",
  "/img/ramekin10/7.webp",
  "/img/ramekin10/8.webp",
];

export default function Ramekin10() {
  ...
  return (
    <>
      <section className={styles.main} id="ramekin10">
        <div className={styles.title_underline}>
          <div className={styles.main_title}>Ramekin N°10:</div>
        ...
        <div className={styles.especifics}>
          <div className={styles.main_block}>
            ...
            <div className={styles.main_sub_text}>
              El Ramekin N°10 es perfecto para porciones individuales pequeñas
              ...
              microondas, lavavajillas y freezer.
              <br />
        ...
        <div className={styles.lightbox} onClick={closeLightbox}>
          ...
          >
            <Image
              ...
              alt={`Ramekin ${selectedImageIndex + 1}`}
              fill
