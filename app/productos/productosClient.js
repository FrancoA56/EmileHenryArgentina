...
import BannerMadeleine from "../../components/bannerMadeleine";
      ...
      <section className={style.main}>
        ...
        <div className={`${style.item} ${style.item2}`}>
          <Link href="vajilla">
            ...
            />
            <div className={style.overlay} />
            <span className={style.text}>Vajillas</span>
          </Link>
        </div>
        <div className={`${style.item} ${style.item3}`}>
          <Link href="ramekin">
            ...
            />
            <div className={style.overlay} />
            <span className={style.text}>Ramekines</span>
          </Link>
        </div>
        <div className={`${style.item} ${style.item4}`}>
          <Link href="pan">
            ...
            />
            <div className={style.overlay} />
            <span className={style.text}>Moldes de Pan</span>
          </Link>
        </div>
